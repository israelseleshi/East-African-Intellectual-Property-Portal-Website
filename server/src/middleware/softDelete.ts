 ...
 */
export const softDeleteMiddleware = async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const addSoftDeleteFilter = (whereClause: string): string => {
 ...
 */
export const buildActiveQuery = (tableName: string, columns: string = '*', whereClause: string = ''): string => {
