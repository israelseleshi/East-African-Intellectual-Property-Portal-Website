...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <ScrollBar className="bg-muted w-2" thumbClassName="bg-[#0e3155] rounded-none" />
...
>(({ className, orientation = "vertical", thumbClassName, ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className={cn("relative flex-1 bg-border", thumbClassName)} />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
